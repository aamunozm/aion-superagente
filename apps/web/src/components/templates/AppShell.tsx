 ...
 * navegación a la izquierda, marca arriba, cuenta abajo, y el contenido de
 * cada sección a la derecha. La navegación vive en `lib/nav.ts`.
 */
    ...
    <div className="h-screen overflow-hidden flex" style={{ background: "var(--bg)" }}>
      ...
      >
        ...
        <div className="px-3 pb-4">
          ...
          >
            <Avatar label={email ?? "?"} size={28} bg="var(--ink)" fg="#fff" />
            {!collapsed && (
