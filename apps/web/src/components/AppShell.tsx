...
type NavItem = { href: string; key: string; icon: "chat" | "folder" | "tools" | "memory" | "sparkle" | "code" | "bulb" | "clock" };
...
const GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/skills", key: "nav.skills", icon: "bulb" },
      { href: "/routines", key: "nav.routines", icon: "clock" },
